/**
 * Class that was the dojox.mobile.SpinWheelSlot, but with all statics now class members
 *
 * @author Jim Ball
 */
define([
    ...
    return declare("mobilehr.widgets.utils.spinners.SpinWheelSlot", [WidgetBase, Contained, ScrollableMixin], {
        /**
         * Put what were statics inside the widget constructor and over-ride these settings by using preamble
         */
        constructor:function () {
            // An array of key-label pairs, e.g. [[0,"Jan"],[1,"Feb"],...]. If key values for each label
            ...
            // version of the items property.
            this.labels = [];
            // The start value of display values of the slot. This parameter is especially useful when slot
            // has serial values.
            this.labelFrom = 0;
            ...
            this.value = "";
            // Internal properties used to control rendering
            this.maxSpeed = 500;
            this.minItems = 15;
            this.centerPos = 0;
            this.scrollBar = false;
            this.constraint = false;
            this.allowNestedScrolls = false;
            // disable workaround in SpinWheel
            this.androidWorkaroud = false;
        },

        buildRendering:function () {
            this.inherited(arguments);
            domClass.add(this.domNode, "mblSpinWheelSlot");
            // override default width of slot
            domClass.add(this.domNode, "mobilehrSpinWheelSlot");
            var i, j, idx;
        ...
        getCenterPanel:function () {
            ...
            for (var i = 0, len = this.panelNodes.length; i < len; i++) {
                ...
                var topOffsetHeight = top + this.panelNodes[i].offsetHeight;
                if ((top <= this.centerPos) && (this.centerPos < topOffsetHeight)) {
        ...
        setValue:function (newValue) {
            // summary: Sets the newValue to this slot.
            var idx0, idx1;
