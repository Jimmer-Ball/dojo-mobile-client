...
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array", "dojo/_base/connect", "dijit/registry",
    ...
    function (declare, lang, array, connect, registry, TransitionEvent, ScrollableView, WidgetHelper, RepresentationHelper) {
        return declare("mobilehr.widgets.utils.time.EndTimeView",
            [ScrollableView, WidgetHelper, RepresentationHelper], {
                ...
                startup:function () {
                    ...
                    this.chooseTimeHeading = registry.byId("chooseEndTimeHeading");
                    ...
                    this.chooseTimeInstructions = this.$("chooseEndTimeInstructions");
                    this.chooseTimeInstructions.innerHTML = _lexicon.chooseEndTimeInstructions;
                    this.chooseTimeSpinner = registry.byId("chooseEndTimeSpinner");
